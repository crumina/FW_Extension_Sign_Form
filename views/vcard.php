...
<div class="ui-block user-welcomeback">
    ...
    <?php if ( $use_buddypress ) { ?>
        <div class="you-can-do"><?php esc_html_e( 'here\'s what you can do!', 'olympus' ); ?></div>
        <div class="links">
            <?php if ( bp_is_active( 'activity' ) ) { ?>
                <a href="<?php echo esc_url( bp_loggedin_user_domain() . bp_get_activity_slug() ); ?>" class="link-item">
                    ...
                    <div class="title"><?php esc_html_e( 'Activity', 'olympus' ); ?></div>
                    <div class="sup-title"><?php esc_html_e( 'Review your activity!', 'olympus' ); ?></div>
                </a>
            <?php } ?>
            <?php if ( bp_is_active( 'notifications' ) ) { ?>
                <a href="<?php echo bp_get_notifications_unread_permalink(); ?>" class="link-item">
                    ...
                    <div class="title"><?php esc_html_e( 'Notifications', 'olympus' ); ?></div>
                    <div class="sup-title"><?php esc_html_e( 'Check out what\'s new!', 'olympus' ); ?></div>
                </a>
            <?php } ?>
            <?php if ( class_exists( 'bbPress' ) && defined( 'BP_FORUMS_SLUG' ) ) { ?>
                <a href="<?php echo esc_url( bp_loggedin_user_domain() . BP_FORUMS_SLUG ); ?>" class="link-item">
                    ...
                    <div class="title"><?php esc_html_e( 'Forums', 'olympus' ); ?></div>
                    <div class="sup-title"><?php esc_html_e( 'Start a new discussion!', 'olympus' ); ?></div>
                </a>
            <?php } ?>
            <?php if ( bp_is_active( 'settings' ) ) { ?>
                <a href="<?php echo esc_url( bp_loggedin_user_domain() . bp_get_settings_slug() ); ?>" class="link-item">
                    ...
                    <div class="title"><?php esc_html_e( 'Settings', 'olympus' ); ?></div>
                    <div class="sup-title"><?php esc_html_e( 'Manage your preferences!', 'olympus' ); ?></div>
                </a>
            <?php } ?>
        </div>
    <?php } ?>
